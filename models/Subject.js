...
var Subject={
    ...
    updateSubjectName:function(Subject,callback){
    	return db.query("UPDATE Subject SET description=?, color=?, primary_type=? WHERE subject_id=?",[Subject.description, Subject.color, Subject.default_type_id, Subject.subject_id], callback);
    } 
};
